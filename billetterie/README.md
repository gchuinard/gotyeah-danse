...
A→Y, 818 places modélisées). Pas de SaaS, pas de commission : un Raspberry Pi 5,
...
- les **818 sièges calibrés** (générés depuis `config/venue.ts`, scores statiques compris) ;
